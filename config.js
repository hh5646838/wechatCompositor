// ============================================================
// 微信公众号 Markdown 一键排版工具 —— 配置中心
// 修改此文件即可全网更新，无需改动 index.html
// ============================================================

// ===== 1. 站点基础配置（头像、链接、公众号、帮助文字等）=====
window.SITE_CONFIG = {
      ...
      JOJO_TOOLBOX_URL: "hh5646838.github.io/aiToolsHomepage",
...
window.CAT_POPUP = {
  title: "猫猫泪水浸湿眼眶",
  message: "您的排版已成功复制！网站需要您花10秒钟阅读文章并点击文末广告，以维持基本运作。当然你也可以残忍关掉弹窗，继续免费使用，哭泣 ( T﹏T )",
  scanTip: "微信扫一扫，阅读文章，点击广告"
};

// ===== 3. 预设主题样式表（12 套，可自由追加）=====
window.PRESET_THEMES = {
      "简约黑": { primary: "#2c2c2c", css: `.content { color: #2c2c2c; font-size: 16px; line-height: 1.85; font-family: -apple-system, BlinkMacSystemFont, "PingFang SC", "Microsoft YaHei", sans-serif; }
...
.content th { background: #f5f5f5; font-weight: 700; }` },
      "学术蓝": { primary: "#1a5fb4", css: `.content { color: #333; font-size: 16px; line-height: 1.9; font-family: Georgia, "Times New Roman", "PingFang SC", "Microsoft YaHei", serif; }
...
.content tr:nth-child(even) td { background: #f0f6fc; }` },
      "活泼橙": { primary: "#ff6b35", css: `.content { color: #3a3a3a; font-size: 16px; line-height: 1.8; font-family: -apple-system, BlinkMacSystemFont, "PingFang SC", "Microsoft YaHei", sans-serif; }
...
.content tr:nth-child(even) td { background: #fff8f3; }` },
      "中国红": { primary: "#c41e3a", css: `.content { color: #3a2a2a; font-size: 16px; line-height: 1.9; font-family: "Songti SC", "SimSun", "PingFang SC", "Microsoft YaHei", serif; }
...
.content tr:nth-child(even) td { background: #fdf5f6; }` },
      "樱桃绿": { primary: "#00A86B", css: `.content { color: #333; font-size: 16px; line-height: 1.85; font-family: -apple-system, BlinkMacSystemFont, "PingFang SC", "Microsoft YaHei", sans-serif; background: #FFFFFF; }
...
.content td:first-child { color: #00A86B; font-weight: 700; }` },
      "稀有紫": { primary: "#6d28d9", css: `.content { color: #374151; font-size: 16px; line-height: 1.85; font-family: -apple-system, BlinkMacSystemFont, "PingFang SC", "Microsoft YaHei", sans-serif; }
...
.content tr:nth-child(even) td { background: #f5f3ff; }` },
      "杂志风": { primary: "#1a1a1a", css: `.content { color: #1a1a1a; font-size: 16px; line-height: 1.8; font-family: -apple-system, BlinkMacSystemFont, "PingFang SC", "Microsoft YaHei", sans-serif; }
...
.content th { background: #1a1a1a; color: #fff; font-weight: 700; text-transform: uppercase; font-size: 12px; letter-spacing: 1px; }` },
      "极客风": { primary: "#00b894", css: `.content { color: #2d3436; font-size: 15px; line-height: 1.75; font-family: "SFMono-Regular", Consolas, "Liberation Mono", Menlo, "PingFang SC", monospace; }
...
.content tr:nth-child(even) td { background: #f8f9fa; }` },
      "波普风": { primary: "#ff006e", css: `.content { color: #1a1a2e; font-size: 16px; line-height: 1.8; font-family: -apple-system, BlinkMacSystemFont, "PingFang SC", "Microsoft YaHei", sans-serif; }
...
.content tr:nth-child(odd) td { background: #f0f4ff; }` },
      "小红书风": { primary: "#FF6B8A", css: `.content { color: #4A4A4A; font-size: 16px; line-height: 1.85; font-family: -apple-system, BlinkMacSystemFont, "PingFang SC", "Microsoft YaHei", sans-serif; background: #FFFAFB; }
...
.content tr:nth-child(even) td { background: #FFF8FA; }` },
      "浪漫风": { primary: "#B088C4", css: `.content { color: #5A4A6A; font-size: 16px; line-height: 1.9; font-family: -apple-system, BlinkMacSystemFont, "PingFang SC", "Microsoft YaHei", sans-serif; background: #FFFFFF; }
...
.content tr:nth-child(even) td { background: #FDF5F9; }` },
      "赛博朋克风": { primary: "#FF2D95", css: `.content { color: #1A1A2E; font-size: 15px; line-height: 1.8; font-family: "SFMono-Regular", Consolas, "Liberation Mono", Menlo, "PingFang SC", monospace; background: #FFFFFF; }
